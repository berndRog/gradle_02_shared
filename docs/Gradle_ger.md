...
Dieses Projekt baut auf `gradle_01_wizard` auf. Die [Beschreibung der Gradle-Basisdateien](https://github.com/berndRog/gradle_01_wizard/blob/master/docs/Gradle_ger.md) gilt weiterhin. Neu sind das Modul `Shared`, seine Registrierung in `settings.gradle.kts`, das Android-Library-Plugin und die Abhängigkeit von `app` auf `Shared`.
